...
class PhoneNumberSerializer(serializers.ModelSerializer):
    """
    Serializer class to serializer phone number.
    """
    phone_number = PhoneNumberField()
...
class AddressReadOnlySerializer(CountryFieldMixin, serializers.ModelSerializer):
    """
    Serializer class to serializer Address model
    """
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'email', 'phone_number', 'first_name', 'last_name', 'is_active', 'addresses',)


class ShippingAddressSerializer(CountryFieldMixin, serializers.ModelSerializer):
    """
    Serializer class to serializer address of type shipping
